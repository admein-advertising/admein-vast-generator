...
// VASTXML represents the root element of a VAST document containing ads and metadata.
...
func (v *VASTXML) Bytes() ([]byte, error) {
...
func Read(reader io.ReadCloser) (*VASTXML, error) {
	defer reader.Close()
